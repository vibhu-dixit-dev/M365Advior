...
M365Advisor is released through the PowerShell Gallery. Security fixes are provided
...
https://github.com/m365advisor365/m365advisor/security/advisories/new

Include enough detail for maintainers to reproduce and assess the vulnerability:

- Affected M365Advisor version or commit.
...
The M365Advisor maintainers will acknowledge vulnerability reports as quickly as
...
Security reports should focus on vulnerabilities in M365Advisor code, workflows,
release artifacts, documentation that could lead to unsafe operation, or bundled
dependencies.

Examples of in-scope reports include:

- Injection, spoofing, or tampering issues in M365Advisor reports or exported data.
- Vulnerable dependency paths that are reachable in supported M365Advisor usage.
...
- Vulnerabilities only present in unsupported M365Advisor versions.
- Findings that require unsupported local modifications.
- General Microsoft 365 configuration findings that are not caused by M365Advisor.
