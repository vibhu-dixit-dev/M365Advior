Describe "M365Advisor/Defender" -Tag "M365Advisor", "Defender" {
    It "MT.1148: Archive Scanning should be enabled. See https://m365advisor.dev/docs/tests/MT.1148" -Tag "MT.1148" {
    ...
    It "MT.1149: Behavior Monitoring should be enabled. See https://m365advisor.dev/docs/tests/MT.1149" -Tag "MT.1149" {
    ...
    It "MT.1150: Cloud Protection should be enabled. See https://m365advisor.dev/docs/tests/MT.1150" -Tag "MT.1150" {
    ...
    It "MT.1151: Email Scanning should be enabled. See https://m365advisor.dev/docs/tests/MT.1151" -Tag "MT.1151" {
    ...
    It "MT.1152: Script Scanning should be enabled. See https://m365advisor.dev/docs/tests/MT.1152" -Tag "MT.1152" {
    ...
    It "MT.1153: Real-time Monitoring should be enabled. See https://m365advisor.dev/docs/tests/MT.1153" -Tag "MT.1153" {
    ...
    It "MT.1154: Full Scan Removable Drives should be enabled. See https://m365advisor.dev/docs/tests/MT.1154" -Tag "MT.1154" {
    ...
    It "MT.1155: Full Scan Mapped Drives should be disabled for performance. See https://m365advisor.dev/docs/tests/MT.1155" -Tag "MT.1155" {
    ...
    It "MT.1156: Scanning Network Files should be enabled. See https://m365advisor.dev/docs/tests/MT.1156" -Tag "MT.1156" {
    ...
    It "MT.1157: CPU Load Factor should be optimized (20-30%). See https://m365advisor.dev/docs/tests/MT.1157" -Tag "MT.1157" {
    ...
    It "MT.1158: Scan should be scheduled. See https://m365advisor.dev/docs/tests/MT.1158" -Tag "MT.1158" {
    ...
    It "MT.1159: Quick Scan Time configuration is not required. See https://m365advisor.dev/docs/tests/MT.1159" -Tag "MT.1159" {
    ...
    It "MT.1160: Signatures should be checked before scan. See https://m365advisor.dev/docs/tests/MT.1160" -Tag "MT.1160" {
    ...
    It "MT.1161: Cloud Block Level should be High or higher. See https://m365advisor.dev/docs/tests/MT.1161" -Tag "MT.1161" {
    ...
    It "MT.1162: Cloud Extended Timeout should be 30-50 seconds. See https://m365advisor.dev/docs/tests/MT.1162" -Tag "MT.1162" {
    ...
    It "MT.1163: Signature Update Interval should be 1-4 hours. See https://m365advisor.dev/docs/tests/MT.1163" -Tag "MT.1163" {
    ...
    It "MT.1164: PUA Protection should be enabled. See https://m365advisor.dev/docs/tests/MT.1164" -Tag "MT.1164" {
    ...
    It "MT.1165: Network Protection should be enabled. See https://m365advisor.dev/docs/tests/MT.1165" -Tag "MT.1165" {
    ...
    It "MT.1166: Local Admin Merge should be disabled. See https://m365advisor.dev/docs/tests/MT.1166" -Tag "MT.1166" {
    ...
    It "MT.1167: Real-Time Scan Direction should cover both directions. See https://m365advisor.dev/docs/tests/MT.1167" -Tag "MT.1167" {
    ...
    It "MT.1168: Cleaned Malware should be retained for at least 30 days. See https://m365advisor.dev/docs/tests/MT.1168" -Tag "MT.1168" {
    ...
    It "MT.1169: Catch-up Full Scan should be disabled. See https://m365advisor.dev/docs/tests/MT.1169" -Tag "MT.1169" {
    ...
    It "MT.1170: Catch-up Quick Scan should be disabled. See https://m365advisor.dev/docs/tests/MT.1170" -Tag "MT.1170" {
    ...
    It "MT.1171: Sample Submission should send safe samples automatically. See https://m365advisor.dev/docs/tests/MT.1171" -Tag "MT.1171" {
