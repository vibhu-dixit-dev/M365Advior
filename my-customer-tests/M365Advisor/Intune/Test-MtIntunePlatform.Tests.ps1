Describe "M365Advisor/Intune" -Tag "M365Advisor", "Intune" {
    ...
    It "MT.1177: Ensure LAPS Configuration Policy is properly set. See https://m365advisor.dev/docs/tests/MT.1177" -Tag "MT.1177" {
    ...
    It "MT.1178: Ensure ASR Rules are configured correctly. See https://m365advisor.dev/docs/tests/MT.1178" -Tag "MT.1178" {
    ...
    It "MT.1179: Ensure App Control for Business is enabled. See https://m365advisor.dev/docs/tests/MT.1179" -Tag "MT.1179" {
    ...
    It "MT.1180: Ensure Managed Installer Rules are configured correctly. See https://m365advisor.dev/docs/tests/MT.1180" -Tag "MT.1180" {
