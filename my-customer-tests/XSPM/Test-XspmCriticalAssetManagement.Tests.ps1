...
Describe "Exposure Management" -Tag "Entra", "Graph",  "XSPM" -Skip:( $DefenderPlan -ne "DefenderXDR" ) {
    ...
    It "MT.1085: Pending approvals for Critical Asset Management should not be present. See https://m365advisor.dev/docs/tests/MT.1085" -Tag "MT.1085" {
