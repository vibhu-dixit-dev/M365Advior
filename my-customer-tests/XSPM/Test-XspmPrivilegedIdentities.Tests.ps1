...
Describe "Exposure Management" -Tag "Privileged", "Entra", "Graph", "LongRunning",  "EntraOps", "XSPM" -Skip:( $DefenderPlan -ne "DefenderXDR" ) {
    ...
    It "MT.1077: App registrations with privileged API permissions should not have owners. See https://m365advisor.dev/docs/tests/MT.1077" -Tag "MT.1077" {
    ...
    It "MT.1078: App registrations with highly privileged directory roles should not have owners. See https://m365advisor.dev/docs/tests/MT.1078" -Tag "MT.1078" {
    ...
    It "MT.1079: Privileged API permissions on service principals should not remain unused. See https://m365advisor.dev/docs/tests/MT.1079" -Tag "MT.1079" {
    ...
    It "MT.1080: Credentials, tokens, or cookies from highly privileged users should not be exposed on vulnerable endpoints. See https://m365advisor.dev/docs/tests/MT.1080" -Tag "MT.1080" {
    ...
    It "MT.1081: Hybrid users should not be assigned Entra ID role assignments. See https://m365advisor.dev/docs/tests/MT.1081" -Tag "MT.1081" {
    ...
    It "MT.1111: High privileged user should be linked to an identity. See https://m365advisor.dev/docs/tests/MT.1111" -Tag "MT.1111", "Preview" {
    ...
    It "MT.1112: Privileged user accounts should not remain enabled when the linked primary account is disabled. See https://m365advisor.dev/docs/tests/MT.1112" -Tag "MT.1112", "Preview" {
