# M365Advisor Test Report

This folder contains the test report for the M365Advisor project.
...
When submitting a PR for changes in `/report/src` you can skip updating the `/powershell/assets/ReportTemplate.html` artifact. The [build-m365advisor-report-template](https://github.com/m365advisor365/m365advisor/blob/main/.github/workflows/build-m365advisor-report-template.yaml) workflow automatically builds and includes an updated ReportTemplate as part of the module publish pipeline.
