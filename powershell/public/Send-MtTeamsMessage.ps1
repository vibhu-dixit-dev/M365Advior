function Send-MtTeamsMessage {
    ...
    .LINK
    https://m365advisor.dev/docs/commands/Send-MtTeamsMessage
    #>
    [CmdletBinding()]
    param(
        ...
        # The subject of the card. Defaults to 'M365Advisor Test Results'.
        [string] $Subject,
    ...
    $adaptiveCardData = @{
        title       = $Subject
        description = "Results for M365Advisor Test run of $($M365AdvisorResults.ExecutedAt)"
        run         = @{
            TenantName       = $M365AdvisorResults.TenantName
            TenantId         = $M365AdvisorResults.TenantId
            ModuleVersion    = $ModuleVersion
            TotalCount       = $M365AdvisorResults.TotalCount
            PassedCount      = $M365AdvisorResults.PassedCount
            FailedCount      = $M365AdvisorResults.FailedCount
