function Get-MtUser {
    ...
    .LINK
    https://m365advisor.dev/docs/commands/Get-MtUser
    #>
        ...
        if ( $UserType -eq "Admin" ) {
            ...
            if ( $EmergencyAccessUsersCount -gt $EmergencyAccessGroupsCount ) {
                ...
                foreach ( $EmergencyAccessGroup in $EmergencyAccessGroups ) {
                    ...
                    # Fetch only the first page to avoid timeout on large groups. Fix for https://github.com/m365advisor365/m365advisor/issues/1227
