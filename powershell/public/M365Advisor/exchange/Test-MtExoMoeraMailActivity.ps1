function Test-MtExoMoeraMailActivity {
    ...
    .LINK
        https://m365advisor.dev/docs/commands/Test-MtExoMoeraMailActivity
    #>
    [CmdletBinding()]
    [OutputType([bool])]
    param()
    ...
    begin {
        ...
        $file = Join-Path -Path ([System.IO.Path]::GetTempPath()) -ChildPath "M365Advisor-EmailActivityUserDetail-$(Get-Date -Format yyMMddHHmmss).csv"
