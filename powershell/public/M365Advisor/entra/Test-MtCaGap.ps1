function Get-ObjectDifference {
    ...
    .LINK
    https://m365advisor.dev/docs/commands/Get-ObjectDifference
    #>
    [CmdletBinding()]
    [OutputType([object[]])]
    param (
...
function Get-RelatedPolicy {
    ...
    .LINK
    https://m365advisor.dev/docs/commands/Get-RelatedPolicy
    #>
    [CmdletBinding()]
    [OutputType([string])]
    param (
...
function Test-MtCaGap {
    ...
    .LINK
    https://m365advisor.dev/docs/commands/Test-MtCaGap
    #>
    [CmdletBinding()]
    [OutputType([bool])]
    param ()
