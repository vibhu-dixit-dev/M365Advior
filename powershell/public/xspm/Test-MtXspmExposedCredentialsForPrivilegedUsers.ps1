function Test-MtXspmExposedCredentialsForPrivilegedUsers {
    ...
    .LINK
    https://m365advisor.dev/docs/commands/Test-MtXspmExposedCredentialsForPrivilegedUsers
    #>
    [CmdletBinding()]
    ...
    if ( $UnifiedIdentityInfoExecutable -eq $false) {
            Add-MtTestResultDetail -SkippedBecause 'Custom' -SkippedCustomReason 'This test requires availability of MDA App Governance and MDI to get data for Defender XDR Advanced Hunting tables. Check https://m365advisor.dev/docs/tests/MT.1080/#Prerequisites for more information.'
            return $null
    }
