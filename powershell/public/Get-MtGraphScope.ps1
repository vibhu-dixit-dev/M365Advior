function Get-MtGraphScope {
    ...
    .LINK
    https://m365advisor.dev/docs/commands/Get-MtGraphScope
    #>
    ...
    # /m365advisor/website/docs/sections/permissions.md
    ...
    # Default read-only scopes required for M365Advisor.
    ...
    # Any changes made to these permission scopes should be reflected in the documentation.
    # /m365advisor/website/docs/sections/privilegedPermissions.md
    $privilegedScopes = @(
