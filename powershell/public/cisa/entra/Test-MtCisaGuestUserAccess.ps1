function Test-MtCisaGuestUserAccess {
    ...
    .LINK
    https://m365advisor.dev/docs/commands/Test-MtCisaGuestUserAccess
    #>
    [CmdletBinding()]
    [OutputType([bool])]
    param()
    ...
    if ($configuredGuestRole) {
        ...
        $testResult = $false
        $testResultMarkdown = "Guest user access is using a new role that is not recognized. Please report this [issue](https://github.com/m365advisor365/m365advisor/issues/new) in the M365Advisor project."
    }
