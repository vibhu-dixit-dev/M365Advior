function Get-MtRegistrableDomain {
    ...
    .DESCRIPTION
        ...
        Public suffix list is sourced from https://publicsuffix.org/ and stored in the M365Advisor powershell assets repository.
    ...
    .LINK
        https://m365advisor.dev/docs/commands/Get-MtRegistrableDomain
    #>
    [OutputType([string])]
    [CmdletBinding()]
    param(
