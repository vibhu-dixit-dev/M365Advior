...
# unreliable on some PowerShell runtimes: when M365Advisor.psm1 dot-sources this file
...
# and 7.6.2 on Linux during Invoke-M365Advisor -- not a PowerShell-version regression),
...
<#
.SYNOPSIS
Initializes the cached Microsoft Entra role definition lookup tables used by M365Advisor.
