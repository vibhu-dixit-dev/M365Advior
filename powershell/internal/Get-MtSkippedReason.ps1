function Get-MtSkippedReason {
    ...
    switch ($SkippedBecause) {
        "NotConnectedAzure" { "Not connected to Azure. See [Connecting to Azure](https://m365advisor.dev/docs/connect-m365advisor/#connect-to-azure-exchange-online-and-teams)"; break }
        "NotConnectedExchange" { "Not connected to Exchange Online. See [Connecting to Exchange Online](https://m365advisor.dev/docs/connect-m365advisor/#connect-to-azure-exchange-online-and-teams)"; break }
        "NotConnectedSecurityCompliance" { "Not connected to Security & Compliance. See [Connecting to Security & Compliance](https://m365advisor.dev/docs/connect-m365advisor/#connect-to-azure-exchange-online-and-teams)"; break }
        "NotConnectedTeams" { "Not connected to Teams. See [Connecting to Teams](https://m365advisor.dev/docs/connect-m365advisor/#connect-to-azure-exchange-online-and-teams)"; break }
        "NotConnectedAzureDevOps" { "Not connected to Azure DevOps. See [Connecting to Azure DevOps](https://m365advisor.dev/docs/connect-m365advisor/#connect-to-azure-devops-optional)"; break }
        "NotConnectedGraph" { "Not connected to Graph. See [Connect-M365Advisor](https://m365advisor.dev/docs/commands/Connect-M365Advisor#examples)"; break }
        "NotConnectedSharePoint" { "Not connected to SharePoint Online. See [Connecting to SharePoint Online](https://m365advisor.dev/docs/connect-m365advisor/#connect-to-sharepoint-online-optional)"; break }
        "NotDotGovDomain" { "This test is only for federal, executive branch, departments and agencies. To override use [Test-MtCisaDmarcAggregateCisa -Force](https://m365advisor.dev/docs/commands/Test-MtCisaDmarcAggregateCisa)"; break }
        ...
        "NotSupportedAppPermission" { "This test relies on Graph APIs that don't support application permissions. Re-run M365Advisor with a user signed in to view the results for this test."; break }
