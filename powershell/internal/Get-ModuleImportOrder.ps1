function Get-ModuleImportOrder {
    ...
    begin {
        ...
        function Get-ModuleImportCandidate {
            ...
            .EXAMPLE
            Get-ModuleImportCandidate -Name 'Pester','M365Advisor'

            Returns PSModuleInfo objects for the versions of the 'Pester' and 'M365Advisor' modules that would be imported by Import-Module.
