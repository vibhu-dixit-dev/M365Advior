function Set-M365AdvisorAppPermission {
    <#
    .SYNOPSIS
    Internal helper function to set Graph API permissions for a M365Advisor application.

    .DESCRIPTION
    This function configures the required Graph API permissions (app roles) for a M365Advisor application
    ...
    .EXAMPLE
    Set-M365AdvisorAppPermission -AppId "12345678-1234-1234-1234-123456789012" -Scopes @("Directory.Read.All", "Policy.Read.All")
    #>
    ...
    process {
        ...
        if ($appSPs.Count -eq 0) {
            throw "Service principal for application not found. Try deleting the M365Advisor app and recreating with New-MtM365AdvisorApp."
        }
