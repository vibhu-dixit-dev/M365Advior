function Write-MtGitHubSecretsManualInstruction {
    ...
    Add-MtM365AdvisorAppFederatedCredential when -SetGitHubSecrets is not used or when the
    ...
    Write-Host "See https://m365advisor.dev/docs/monitoring/github#add-entra-tenant-info-to-github-repos for details." -ForegroundColor Yellow
    Write-Host ""
}
