Describe 'Get-IsNewM365AdvisorVersionAvailable' {
    BeforeAll {
        . "$PSScriptRoot/../../internal/Get-MtLatestModuleVersion.ps1"
        . "$PSScriptRoot/../../internal/Get-MtModuleVersion.ps1"
        . "$PSScriptRoot/../../internal/Get-IsNewM365AdvisorVersionAvailable.ps1"
    }
    ...
    Context 'When a newer version exists' {
        It 'returns true' {
            ...
            $result = Get-IsNewM365AdvisorVersionAvailable
    ...
    Context 'When version lookup throws' {
        It 'returns false and does not throw' {
            ...
            { Get-IsNewM365AdvisorVersionAvailable } | Should -Not -Throw
            Get-IsNewM365AdvisorVersionAvailable | Should -BeFalse
        }
    }
