Describe 'Get-MtUser' {
    ...
    Context 'When CA policies have no group exclusions' {
        BeforeAll {
            ...
            Mock -ModuleName M365Advisor Invoke-MtGraphRequest { return $null }
        }

        It 'Should return an empty result without calling the members endpoint' {
            $result = Get-MtUser -UserType EmergencyAccess
            $result | Should -BeNullOrEmpty
            Should -Invoke Invoke-MtGraphRequest -ModuleName M365Advisor -Exactly 0 -ParameterFilter {
    ...
    Context 'When the auto-detected group is small (valid emergency access group)' {
        BeforeAll {
            ...
            Mock -ModuleName M365Advisor Get-MtConditionalAccessPolicy { return $policies }
            Mock -ModuleName M365Advisor Invoke-MtGraphRequest {
        ...
        It 'Should call the members endpoint for the correct group' {
            ...
            Should -Invoke Invoke-MtGraphRequest -ModuleName M365Advisor -ParameterFilter {
    ...
    Context 'When group members endpoint is called with -DisablePaging' {
        BeforeAll {
            ...
            Mock -ModuleName M365Advisor Get-MtConditionalAccessPolicy { return $policies }
            Mock -ModuleName M365Advisor Invoke-MtGraphRequest { return New-MockGroupMembersResponse -Count 2 }
        }
