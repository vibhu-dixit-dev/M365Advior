---
title: "Introducing M365Advisor 2.0 🚀"
description: A major release with 400+ commits, 15+ new security tests, XSPM integration, enhanced reports, and more.
slug: m365advisor-2-0
authors: [m365advisorteam]
tags: [m365advisor, release, security, entra, m365]
hide_table_of_contents: false
date: 2026-02-11
---

# Introducing M365Advisor 2.0 🚀

We're excited to announce **M365Advisor 2.0** - our biggest release yet! With over 400 commits since version 1.3.0, this release brings powerful new capabilities for Microsoft 365 security testing.
...
- **New M365Advisor App Management Commands** - Simplified DevOps pipeline setup

---

Here's a deeper dive into what's new in M365Advisor 2.0:

![M365Advisor 2.0](./img/1.png)

![M365Advisor 2.0](./img/2.png)

![M365Advisor 2.0](./img/3.png)

![M365Advisor 2.0](./img/4.png)

![M365Advisor 2.0](./img/5.png)

![M365Advisor 2.0](./img/6.png)

![M365Advisor 2.0](./img/7.png)

![M365Advisor 2.0](./img/8.png)

![M365Advisor 2.0](./img/9.png)

![M365Advisor 2.0](./img/10.png)

## New Reporting Capabilities

The M365Advisor report has been completely redesigned with new views and capabilities.

![Report Views](./img/m365advisor-2.0-report.png)
...
```powershell
# Run all new tests
Invoke-M365Advisor -Tag "MT.1068", "MT.1069", "MT.1070"

# Run all Entra tests
Invoke-M365Advisor -Tag "Entra"
```
...
```powershell
# Run XSPM tests
Invoke-M365Advisor -Tag "XSPM"

# Check for credential exposure
Invoke-M365Advisor -Tag "XSPM" -Path ./tests/XSPM
```
...
Invoke-M365Advisor -OutputFolder ./results
...
Define your break-glass accounts in the M365Advisor configuration to improve test accuracy.
...
Edit your `m365advisor-config.json`:
...
## ⚡ M365Advisor App Management

New cmdlets to simplify setting up M365Advisor for DevOps pipelines.

### New Commands

| Command | Description |
|---------|-------------|
| `New-MtM365AdvisorApp` | Create a M365Advisor app with required permissions |
| `Get-MtM365AdvisorApp` | Retrieve existing M365Advisor app details |
| `Update-MtM365AdvisorApp` | Update app permissions and settings |
| `Add-MtM365AdvisorAppFederatedCredential` | Add GitHub Actions federated credentials |
...
```powershell
# Create a new M365Advisor app for GitHub Actions
New-MtM365AdvisorApp -Name "M365Advisor Pipeline" -GitHubOrganization "myorg" -GitHubRepository "m365advisor-tests"

# Include mail sending for notifications
New-MtM365AdvisorApp -Name "M365Advisor Pipeline" -SendMail

# Add federated credential to existing app
Add-MtM365AdvisorAppFederatedCredential -GitHubOrganization "myorg" -GitHubRepository "m365advisor-tests"
```
...
- @tdcthosc - CISA improvements, CIS refactors, Invoke-M365Advisor enhancements
...
Update to M365Advisor 2.0 today:

```powershell
# Update the M365Advisor module
...
- [M365Advisor Documentation](https://m365advisor.dev/docs)
- [GitHub Repository](https://github.com/m365advisor365/m365advisor)
- [Join us on Discord](https://discord.gg/m365advisor)

Have feedback or found a bug? [Open an issue](https://github.com/m365advisor365/m365advisor/issues) on GitHub!
