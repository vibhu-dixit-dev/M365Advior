...
description: Monitor multiple Microsoft 365 tenants in a single M365Advisor report with a tenant selector
...
We are excited to announce that M365Advisor now supports multi-tenant reports! Run your security tests across multiple tenants and view the results in a single report. 🚀
...
- 🚀 Run M365Advisor tests across multiple tenants in a single pipeline run
...
- ⚙️ Tenant-specific `m365advisor-config.{TenantId}.json` support
