...
```powershell
Send-MtMail [-M365AdvisorResults] <PSObject> [-Recipient] <String[]> [-Subject <String>]
 [-TestResultsUri <String>] [-CreateBodyOnly] [-UserId <String>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
