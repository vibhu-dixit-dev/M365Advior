...
sidebar_position: 1
title: Sending M365Advisor alerts
---

M365Advisor can be set up to send alerts at the end of each monitoring cycle. This can be done using email, Teams, Slack or other methods.
