...
sidebar_position: 11
title: Set up M365Advisor Teams alerts
---
...
![M365Advisor - Microsoft Teams Alerts](assets/m365advisor-teams-alert-test-result.png)
...
## Invoke-M365Advisor with the webhook
...
Update your GitHub/Azure DevOps daily monitoring workflow to send the alert using `Send-MtTeamsMessage` after the M365Advisor tests have been run.
...
# Send the summary using the results
Send-MtTeamsMessage -M365AdvisorResults $M365AdvisorResults -TeamId '00000000-0000-0000-0000-000000000000' -TeamChannelId '19%3A00000000000000000000000000000000%40thread.tacv2' -Subject 'M365Advisor Results'
...
## Adding a link to detailed M365Advisor results
