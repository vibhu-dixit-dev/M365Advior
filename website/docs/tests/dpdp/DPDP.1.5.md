---
title: "DPDP.1.5 - DPO and Data Fiduciary contact info SHALL be published in tenant policy metadata (Rule 3(vi))."
...
# DPDP.1.5 - DPO and Data Fiduciary contact info SHALL be published in tenant policy metadata (Rule 3(vi)).
...
| Tags | DPDP, DPDP.1.5, DPDP2023, IndiaDPDP |
