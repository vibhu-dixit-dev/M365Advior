---
title: "DPDP.Sec.06.4 - Ensure external guest user directory permissions are strictly restricted"
...
# DPDP.Sec.06.4 - Ensure external guest user directory permissions are strictly restricted
