---
title: "DPDP.3.8 - TLS 1.2+ mandatory transport encryption SHALL be enforced for Exchange Online (Rule 8(5)-Sec-2)."
...
# DPDP.3.8 - TLS 1.2+ mandatory transport encryption SHALL be enforced for Exchange Online (Rule 8(5)-Sec-2).
...
| Tags | DPDP, DPDP.3.8, DPDP2023, IndiaDPDP |
