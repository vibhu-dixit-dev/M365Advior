---
title: "DPDP.Sec.08.17 - Ensure Zero-Hour Auto Purge (ZAP) for phishing and malware is enabled in Exchange Online"
...
| Field | Value |
| --- | --- |
| Test ID | DPDP.Sec.08.17 |
| Severity | Unknown |
| Suite | DPDP Act 2023 |
| Category | General |
| PowerShell test | [Test-MtCisZAP](/docs/commands/Test-MtCisZAP) |
| Tags | DPDP, DPDP.Sec.08, DPDP.Sec.08.17, DPDP2023 |
