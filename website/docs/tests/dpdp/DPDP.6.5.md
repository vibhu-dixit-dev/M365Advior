---
title: "DPDP.6.5 - Right to Data Portability SHALL support structured CSV/JSON data exports (Rule 11-12-Req-4)."
...
# DPDP.6.5 - Right to Data Portability SHALL support structured CSV/JSON data exports (Rule 11-12-Req-4).
...
| Tags | DPDP, DPDP.6.5, DPDP2023, IndiaDPDP |
