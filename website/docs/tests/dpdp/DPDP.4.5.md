---
title: "DPDP.4.5 - Direct sign-in to Shared Mailboxes SHALL be disabled (Rule 8(5))."
...
# DPDP.4.5 - Direct sign-in to Shared Mailboxes SHALL be disabled (Rule 8(5)).
...
| Tags | DPDP, DPDP.4.5, DPDP2023, IndiaDPDP |
