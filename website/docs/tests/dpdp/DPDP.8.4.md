---
title: "DPDP.8.4 - Hosted connection filter and IP access rules SHALL be documented (Rule 6(2))."
...
# DPDP.8.4 - Hosted connection filter and IP access rules SHALL be documented (Rule 6(2)).
...
| Tags | DPDP, DPDP.8.4, DPDP2023, IndiaDPDP |
