---
title: "DPDP.3.7 - BitLocker Encryption SHALL be enforced on endpoints processing personal data (Rule 8(5)-Sec-3)."
...
# DPDP.3.7 - BitLocker Encryption SHALL be enforced on endpoints processing personal data (Rule 8(5)-Sec-3).
...
| Tags | DPDP, DPDP.3.7, DPDP2023, IndiaDPDP |
