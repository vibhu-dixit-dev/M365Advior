---
title: "DPDP.3.11 - Phishing protection and anti-spoofing DMARC/DKIM records SHALL be active (Rule 8(5)-Sec-6)."
...
# DPDP.3.11 - Phishing protection and anti-spoofing DMARC/DKIM records SHALL be active (Rule 8(5)-Sec-6).
...
| Tags | DPDP, DPDP.3.11, DPDP2023, IndiaDPDP |
