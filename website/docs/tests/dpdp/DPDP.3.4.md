---
title: "DPDP.3.4 - Data Loss Prevention (DLP) policies SHALL block outbound transfer of Indian PII/SPII (Rule 8(5)-Sec-9)."
...
# DPDP.3.4 - Data Loss Prevention (DLP) policies SHALL block outbound transfer of Indian PII/SPII (Rule 8(5)-Sec-9).
...
| Tags | DPDP, DPDP.3.4, DPDP2023, IndiaDPDP |
