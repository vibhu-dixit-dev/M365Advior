---
title: "DPDP.8.3 - Outbound exfiltration and spam filter policies SHALL be configured (Rule 6(2))."
...
# DPDP.8.3 - Outbound exfiltration and spam filter policies SHALL be configured (Rule 6(2)).
...
| Tags | DPDP, DPDP.8.3, DPDP2023, IndiaDPDP |
