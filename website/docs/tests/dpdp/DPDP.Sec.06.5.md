---
title: "DPDP.Sec.06.5 - Ensure guest users are dynamically categorized for automated lifecycle governance"
...
# DPDP.Sec.06.5 - Ensure guest users are dynamically categorized for automated lifecycle governance
