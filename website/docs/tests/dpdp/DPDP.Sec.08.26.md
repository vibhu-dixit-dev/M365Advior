---
title: "DPDP.Sec.08.26 - Ensure Exchange connection filter safe-lists are not configured with 0.0.0.0 bypasses"
...
# DPDP.Sec.08.26 - Ensure Exchange connection filter safe-lists are not configured with 0.0.0.0 bypasses
