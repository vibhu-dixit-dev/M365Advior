---
title: "DPDP.3.1 - Multi-Factor Authentication (MFA) SHALL be enforced for all users handling personal data (Rule 8(5)-Sec-1)."
...
# DPDP.3.1 - Multi-Factor Authentication (MFA) SHALL be enforced for all users handling personal data (Rule 8(5)-Sec-1).
...
| Tags | DPDP, DPDP.3.1, DPDP2023, IndiaDPDP |
