---
title: "DPDP.Sec.08.2 - Ensure weak and legacy authentication protocols are disabled across the tenant"
...
# DPDP.Sec.08.2 - Ensure weak and legacy authentication protocols are disabled across the tenant
