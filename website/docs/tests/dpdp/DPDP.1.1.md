---
title: "DPDP.1.1 - Purview Sensitivity Labels SHALL be configured to discover and classify Indian PII/SPII data (Rule 3(i))."
...
# DPDP.1.1 - Purview Sensitivity Labels SHALL be configured to discover and classify Indian PII/SPII data (Rule 3(i)).
...
| Tags | DPDP, DPDP.1.1, DPDP2023, IndiaDPDP |
