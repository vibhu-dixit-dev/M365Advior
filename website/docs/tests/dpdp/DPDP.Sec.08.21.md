---
title: "DPDP.Sec.08.21 - Ensure DKIM signing is enabled on all custom mail domains to prevent spoofing"
...
# DPDP.Sec.08.21 - Ensure DKIM signing is enabled on all custom mail domains to prevent spoofing
...
| Field | Value |
| --- | --- |
| Test ID | DPDP.Sec.08.21 |
| Severity | Unknown |
| Suite | DPDP Act 2023 |
| Category | General |
| PowerShell test | [Test-MtCisDkim](/docs/commands/Test-MtCisDkim) |
| Tags | DPDP, DPDP.Sec.08, DPDP.Sec.08.21, DPDP2023 |
