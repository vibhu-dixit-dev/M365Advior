---
title: "DPDP.2.1 - Consent Manager & Service Principal API authentication SHALL enforce TLS transport security (Rule 4(3)(d))."
...
# DPDP.2.1 - Consent Manager & Service Principal API authentication SHALL enforce TLS transport security (Rule 4(3)(d)).
...
| Tags | DPDP, DPDP.2.1, DPDP2023, IndiaDPDP |
