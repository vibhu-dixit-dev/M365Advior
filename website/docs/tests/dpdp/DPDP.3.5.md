---
title: "DPDP.3.5 - Exchange Online attachment and file filtering policies SHALL be active (Rule 8(5)-Sec-9)."
...
# DPDP.3.5 - Exchange Online attachment and file filtering policies SHALL be active (Rule 8(5)-Sec-9).
...
| Tags | DPDP, DPDP.3.5, DPDP2023, IndiaDPDP |
