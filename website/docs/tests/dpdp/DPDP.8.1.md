---
title: "DPDP.8.1 - Unified Audit Logging (UAL) SHALL be enabled with minimum 180+ days retention (Rule 8(5)-Sec-5)."
...
# DPDP.8.1 - Unified Audit Logging (UAL) SHALL be enabled with minimum 180+ days retention (Rule 8(5)-Sec-5).
...
| Tags | DPDP, DPDP.8.1, DPDP2023, IndiaDPDP |
