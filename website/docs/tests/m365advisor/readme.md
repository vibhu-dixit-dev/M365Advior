...
| [MT.1033](../MT.1033) | MT.1033.$($RegularUsersList.IndexOf($_)): User should be blocked from using legacy authentication ($($_.userPrincipalName)) | Unknown | CA |
| [MT.1034](../MT.1034) | MT.1034.$($EmergencyAccessUsersList.IndexOf($_)): Emergency access users should not be blocked ($($_.userPrincipalName)) | Unknown | CA |
