...
## A custom M365Advisor test to check conditional access policies standards
...
You can run the test using `Invoke-M365Advisor` and check the results.
...
To provide more context in the test results, you can use M365Advisor's `Add-MtTestResultDetail` function to provide additional context.
...
To add support for additional types see [Add-MtTestResultDetail](https://github.com/m365advisor365/m365advisor/blob/main/powershell/public/Add-MtTestResultDetail.ps1) and [Get-GraphObjectMarkdown](https://github.com/m365advisor365/m365advisor/blob/main/powershell/internal/Get-GraphObjectMarkdown.ps1).
...
Here's an alternative version using the out of the box M365Advisor cmdlets for getting CA policies and displaying the results.
