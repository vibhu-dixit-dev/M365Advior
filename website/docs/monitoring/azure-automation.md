...
# <IIcon icon="devicon:azure" height="48" /> Setup M365Advisor in Azure Automation

This guide will walk you through setting up M365Advisor in Azure Automation and automate the running of tests using Runbooks.

## Why Azure Automation?

Azure Automation provides a simple and effective method to automate email reporting with M365Advisor. Azure Automation has a free-tier option, giving you up to 500 minutes of execution each month without additional cost.
...
- Select **+ Create**.
  ...
  - Enter a name for the account (e.g. `M365Advisor-Automation-Account`) and select a **region**.
- Select **Next**.
...
- Uncomment the **-SendMail** switch in the Get-MtGraphScope line, if the automation needs to email the M365Advisor report.
...
```powershell
$managedIdentityName = "M365Advisor-Automation-Account" #Name of the Automation Account created in the previous step
...
![Screenshot of the M365Advisor report email](assets/azureautomation-test-result.png)
