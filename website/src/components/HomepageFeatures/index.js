...
const FeatureList = [
  {
    ...
    description: (
      <>
        M365 Advisor comes with a collection of ready to use tests to help you get
  ...
  },
  {
    ...
    description: (
      <>
        Since M365 Advisor is built using Pester and Microsoft Graph, you can write
  ...
  },
  {
    ...
    description: (
      <>
        Each test in M365 Advisor comes with details of the configuration settings
  ...
  },
  {
    ...
    description: (
      <>
        M365 Advisor natively integrates Entra ID Security Config Analyzer to provide
