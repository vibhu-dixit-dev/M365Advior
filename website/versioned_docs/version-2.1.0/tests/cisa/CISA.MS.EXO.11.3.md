---
title: "CISA.MS.EXO.11.3 - The phishing protection solution SHOULD include an AI-based phishing detection tool comparable to EOP Mailbox Intelligence."
description: "The phishing protection solution SHOULD include an AI-based phishing detection tool comparable to EOP Mailbox Intelligence. Rationale: Phishing attacks can result in unauthorized data disclosure and unauthorized access. Using AI-based phishing detection tools to improve the detection rate of phishi…"
slug: /tests/CISA.MS.EXO.11.3
...
| Suite | CISA |
| Category | exchange |
| PowerShell test | [Test-MtCisaMailboxIntelligence](/docs/commands/Test-MtCisaMailboxIntelligence) |
| Tags | CISA, CISA.MS.EXO.11.3, MS.EXO, MS.EXO.11.3 |

## Source

- Pester test: `tests/cisa/exchange/Test-MtCisaMailboxIntelligence.Tests.ps1`
- PowerShell source: `powershell/public/cisa/exchange/Test-MtCisaMailboxIntelligence.ps1`
