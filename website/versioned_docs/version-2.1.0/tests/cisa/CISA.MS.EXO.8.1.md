---
title: "CISA.MS.EXO.8.1 - A DLP solution SHALL be used."
description: "A DLP solution SHALL be used. Rationale: Users may inadvertently disclose sensitive information to unauthorized individuals. A DLP solution may detect the presence of sensitive information in Exchange Online and block access to unauthorized entities. Remediation action: 1. Sign in to the **Microsof…"
slug: /tests/CISA.MS.EXO.8.1
...
| Field | Value |
| --- | --- |
| Test ID | CISA.MS.EXO.8.1 |
| Severity | High |
| Suite | CISA |
| Category | exchange |
| PowerShell test | [Test-MtCisaDlp](/docs/commands/Test-MtCisaDlp) |
| Tags | CISA, CISA.MS.EXO.8.1, MS.EXO, MS.EXO.8.1 |

## Source

- Pester test: `tests/cisa/exchange/Test-MtCisaDlp.Tests.ps1`
- PowerShell source: `powershell/public/cisa/exchange/Test-MtCisaDlp.ps1`
