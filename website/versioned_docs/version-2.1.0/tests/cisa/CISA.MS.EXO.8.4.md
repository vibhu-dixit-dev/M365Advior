---
title: "CISA.MS.EXO.8.4 - At a minimum, the DLP solution SHALL restrict sharing credit card numbers, U.S. Individual Taxpayer Identification Numbers (ITIN), and U.S. Social Security numbers (SSN) via email."
description: "At a minimum, the DLP solution SHALL restrict sharing credit card numbers, U.S. Individual Taxpayer Identification Numbers (ITIN), and U.S. Social Security numbers (SSN) via email. > Reference your organization's policy defining restricted information. Rationale: Users may inadvertently share sensi…"
slug: /tests/CISA.MS.EXO.8.4
...
- Pester test: `tests/cisa/exchange/Test-MtCisaDlpBaselineRule.Tests.ps1`
- PowerShell source: `powershell/public/cisa/exchange/Test-MtCisaDlpBaselineRule.ps1`
