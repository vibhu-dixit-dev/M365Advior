---
title: "CISA.MS.EXO.9.5 - At a minimum, click-to-run files SHOULD be blocked (e.g., .exe, .cmd, and .vbe)."
description: "At a minimum, click-to-run files SHOULD be blocked (e.g., .exe, .cmd, and .vbe). Rationale: Malicious attachments often take the form of click-to-run files. Blocking a list of common executable files helps mitigate the risk of adversarial exploitation. Remediation action: 1. Sign in to **Microsoft…"
slug: /tests/CISA.MS.EXO.9.5
...
- Pester test: `tests/cisa/exchange/Test-MtCisaBlockExecutable.Tests.ps1`
- PowerShell source: `powershell/public/cisa/exchange/Test-MtCisaBlockExecutable.ps1`
