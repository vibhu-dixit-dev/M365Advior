...
Describe "Exposure Management" -Tag "XSPM", "LongRunning", "Device" -Skip:( $DefenderPlan -ne "DefenderXDR" ) {
    ...
    It "MT.1086: Devices should not share both critical and non-critical user credentials. See https://m365advisor.dev/docs/tests/MT.1086" -Tag "MT.1086" {
    ...
    It "MT.1087: Devices should not be publicly exposed with remotely exploitable, highly likely to be exploited, high or critical severity CVE's. See https://m365advisor.dev/docs/tests/MT.1087" -Tag "MT.1087" {
    ...
    It "MT.1088: Devices with critical credentials should be protected by TPM. See https://m365advisor.dev/docs/tests/MT.1088" -Tag "MT.1088" {
    ...
    It "MT.1089: Devices with critical credentials should be protected by Credential Guard. See https://m365advisor.dev/docs/tests/MT.1089" -Tag "MT.1089" {
