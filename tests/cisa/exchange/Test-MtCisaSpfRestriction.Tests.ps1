Describe "CISA" -Tag "MS.EXO", "MS.EXO.2.1", "CISA.MS.EXO.2.1", "CISA" {
    It "CISA.MS.EXO.2.1: A list of approved IP addresses for sending mail SHALL be maintained." -Tag "Deprecated" {
