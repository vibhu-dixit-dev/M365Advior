Describe "M365Advisor/Entra" -Tag "M365Advisor", "Privileged" {
    It "MT.1025: No external user with permanent role assignment on Control Plane. See https://m365advisor.dev/docs/tests/MT.1025" -Tag "MT.1025" {
    ...
    It "MT.1026: No hybrid user with permanent role assignment on Control Plane. See https://m365advisor.dev/docs/tests/MT.1026" -Tag "MT.1026" {
    ...
    It "MT.1027: No Service Principal with Client Secret and permanent role assignment on Control Plane. See https://m365advisor.dev/docs/tests/MT.1027" -Tag "MT.1027" {
    ...
    It "MT.1028: No user with mailbox and permanent role assignment on Control Plane. See https://m365advisor.dev/docs/tests/MT.1028" -Tag "MT.1028" {
...
Describe "M365Advisor/Entra" -Tag "Privileged",  "PIM" {
    It "MT.1029: Stale accounts are not assigned to privileged roles. See https://m365advisor.dev/docs/tests/MT.1029" -Tag "MT.1029" {
    ...
    It "MT.1030: Eligible role assignments on Control Plane are in use by administrators. See https://m365advisor.dev/docs/tests/MT.1030" -Tag "MT.1030" {
        if ( ( Get-MtLicenseInformation EntraID ) -ne "P2" ) {
            Add-MtTestResultDetail -SkippedBecause NotLicensedEntraIDP2
        } else {
    ...
    It "MT.1031: Privileged role on Control Plane are managed by PIM only. See https://m365advisor.dev/docs/tests/MT.1031" -Tag "MT.1031" {
        if ( ( Get-MtLicenseInformation EntraID ) -ne "P2" ) {
            Add-MtTestResultDetail -SkippedBecause NotLicensedEntraIDP2
        } else {
    ...
    It "MT.1032: Limited number of Global Admins are assigned. See https://m365advisor.dev/docs/tests/MT.1032" -Tag "MT.1032" {
        if ( ( Get-MtLicenseInformation EntraID ) -ne "P2" ) {
            Add-MtTestResultDetail -SkippedBecause NotLicensedEntraIDP2
        } else {
