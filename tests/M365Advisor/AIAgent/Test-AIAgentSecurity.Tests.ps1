BeforeDiscovery {
    # Tests run when the Dataverse service is connected. The environment URL is
    # resolved at connect time — either explicitly configured in m365advisor-config.json
    # or auto-discovered via the Global Discovery Service.
    $DataverseConnected = $__MtSession.Connections -contains 'Dataverse' -or $__MtSession.Connections -contains 'All'
    if (-not $DataverseConnected) {
        Write-Verbose "Dataverse service not connected. Copilot Studio agent security tests will be skipped. Use 'Connect-M365Advisor -Service Dataverse' to enable."
    }
}

Describe "Copilot Studio Agent Security" -Tag "M365Advisor", "AIAgent", "CopilotStudio" -Skip:( -not $DataverseConnected ) {
    # AI agents should not be shared with broad access control policies.
    It "MT.1113: AI agents should not be shared with broad access control policies. See https://m365advisor.dev/docs/tests/MT.1113" -Tag "MT.1113" {
    ...
    It "MT.1114: AI agents should require user authentication. See https://m365advisor.dev/docs/tests/MT.1114" -Tag "MT.1114" {
    ...
    It "MT.1115: AI agents should not have risky HTTP configurations. See https://m365advisor.dev/docs/tests/MT.1115" -Tag "MT.1115" {
    ...
    It "MT.1116: AI agents should not send email with AI-controlled inputs. See https://m365advisor.dev/docs/tests/MT.1116" -Tag "MT.1116" {
    ...
    It "MT.1117: Published AI agents should not be dormant. See https://m365advisor.dev/docs/tests/MT.1117" -Tag "MT.1117" {
    ...
    It "MT.1118: AI agents should not use author (maker) authentication for connections. See https://m365advisor.dev/docs/tests/MT.1118" -Tag "MT.1118" {
    ...
    It "MT.1119: AI agents should not have hard-coded credentials in topics. See https://m365advisor.dev/docs/tests/MT.1119" -Tag "MT.1119" {
    ...
    It "MT.1120: AI agents should not use MCP server tools without review. See https://m365advisor.dev/docs/tests/MT.1120" -Tag "MT.1120" {
    ...
    It "MT.1121: AI agents with generative orchestration should have custom instructions. See https://m365advisor.dev/docs/tests/MT.1121" -Tag "MT.1121" {
    ...
    It "MT.1122: AI agents should not have orphaned ownership. See https://m365advisor.dev/docs/tests/MT.1122" -Tag "MT.1122" {
