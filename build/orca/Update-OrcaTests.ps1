...
foreach ($file in $testFiles) {
    ...
    # Confirm to M365Advisor convention
    ...
    # IF testId is not in M365Advisor format of (ORCA.n or ORCA.n.n) the last number is optional and can be any number of digits, display error and ask to update this code and abort
...
function Test-$($content.func){
    ...
    .LINK
        https://m365advisor.dev/docs/commands/Test-$($content.func)
    #>
    [CmdletBinding()]
    [OutputType([bool])]
    param()
