# Description: This script is used to generate the 'Command Reference' section of the M365Advisor docusaurus site
...
New-DocusaurusHelp -Module ./powershell/M365Advisor.psm1 -DocsFolder ./website/docs -NoPlaceHolderExamples -EditUrl https://github.com/m365advisor365/m365advisor/blob/main/powershell/public/ -Exclude $commandsToExclude
