...
./build/Build-M365AdvisorModule.ps1 -Format

# Build with import-time profiling
./build/Build-M365AdvisorModule.ps1 -Profile

# Custom output location
./build/Build-M365AdvisorModule.ps1 -OutputRoot ./out
```
...
- `M365Advisor.Format.ps1xml` (type formatting)
...
Copies the source `M365Advisor.psd1` to the output directory and updates:
...
Copies the `tests/` directory to `m365advisor-tests/` in the output. Tests are
...
├── m365advisor-tests/             # Test suites (copied from tests/)
├── M365Advisor.Format.ps1xml      # Type formatting definitions
├── M365Advisor.psd1               # Updated module manifest
├── M365Advisor.psm1               # Consolidated module script
...
- **The hardcoded PSM1 preamble** (module header, `#Requires`,
  `$__MtSession`) currently mirrors the source `M365Advisor.psm1`. If new session
  ...
  [issue #1559](https://github.com/m365advisor365/m365advisor/issues/1559).
