...
- .claude/agents/m365advisor-test-expert.md
- .github/skills/m365advisor-test-expert/SKILL.md
...
- .github/agents/m365advisor-issue-manager.agent.md
- .github/agents/m365advisor-test-planner.agent.md
- .github/agents/m365advisor-test-expert.agent.md

The **issue manager** and **planner** agents are designed primarily to support the **M365Advisor Test Expert** skill and not be invoked by users directly. The **test-expert** agent may prove to be redundant, and is for now included as a proxy to the skill until the most effective entry point for GitHub Copilot is determined.
